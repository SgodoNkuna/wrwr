...
function LegalShell({ title, intro, children }: { title: string; intro: string; children: ReactNode }) {
  ...
  return (
    <div className="container-x max-w-3xl py-12">
      ...
      <div className="legal mt-8 space-y-4 leading-relaxed text-farm-950/85 [&_h2]:mt-8 [&_h2]:text-2xl [&_li]:ml-5 [&_li]:list-disc [&_a]:font-semibold [&_a]:text-farm-700 [&_a]:underline">
        <p>{intro}</p>
        {children}
      </div>
    </div>
  ...
  return (
    <LegalShell title="Privacy Policy" intro={`This policy explains how ${legal} ("we", "us") collects, uses and protects your personal information in line with the Protection of Personal Information Act 4 of 2013 (POPIA).`}>
      ...
      <ul>
        ...
        <li>Our staff activity audit log is deleted automatically after 36 months.</li>
      ...
      <p>To make a request, contact our Information Officer using the details above. We will respond within a reasonable time, and we may need to confirm your identity first.</p>
...
export function TermsOfUse() {
  ...
  return (
    <LegalShell title="Terms of Use" intro={`These terms apply to your use of this website operated by ${legal}. By using the site you agree to them.`}>
      ...
      <h2>3. Livestock, poultry and produce</h2>
      <ul>
      ...
      <h2>8. Business information (ECT Act s43)</h2>
      <ul>
  ...
  return (
    <LegalShell title="Cookie Policy" intro="This page explains the cookies and similar browser storage this website uses and how you can control them.">
      ...
      <ul>
        ...
        <li><b>Staff login session</b> (<code>sb-…-auth-token</code>, local storage): used only when a staff member signs in to the admin area.</li>
      </ul>
